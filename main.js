window.onload = function () {
  var canvaswidth = 600; // largeur réduite
  var canvasheight = 400; // hauteur réduite
  var blocksize = 30;
  var ctx;
  var delay = 100;
  var snakee;
  ...
  function gameOver() {
    ...
    ctx.strokeText("GAME OVER", centreX, centreY - 60); // ajustement de la position du texte
    ctx.fillText("GAME OVER", centreX, centreY - 60); // ajustement de la position du texte
  ...
  function drawScore() {
    ...
    ctx.fillStyle = "gray";
    ctx.textAlign = "center"; // correction de 'centre' à 'center'
    ctx.textBaseline = "middle";
    var centreX = canvaswidth / 2;
    var centreY = canvasheight / 2;
